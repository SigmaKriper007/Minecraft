...
public class ModBlocks {
    ...
    public static final Block LAB_FLOOR_GRATE = register("lab_floor_grate",
        new Block(BlockBehaviour.Properties.of().strength(2.0f, 5.0f).sound(SoundType.METAL)));
    ...
    public static final Block CITADEL_VEIN = register("citadel_vein",
        new Block(BlockBehaviour.Properties.of().strength(2.5f, 5.0f).lightLevel(s -> 7)));
    ...
    public static final Block DATA_CONDUIT = register("data_conduit",
        new Block(BlockBehaviour.Properties.of().strength(3.0f, 6.0f).sound(SoundType.METAL)));
    ...
    public static final Block SIGNAL_PANEL = register("signal_panel",
        new Block(BlockBehaviour.Properties.of().strength(2.5f, 5.0f).sound(SoundType.METAL).lightLevel(s -> 6)));
    ...
    public static final Block WELDING_BENCH = register("welding_bench",
        new Block(BlockBehaviour.Properties.of().strength(2.5f, 5.0f).sound(SoundType.METAL)));
    ...
    public static final Block HAZARD_EMITTER = register("hazard_emitter",
        new Block(BlockBehaviour.Properties.of().strength(2.5f, 5.0f).sound(SoundType.METAL).lightLevel(s -> 7)));
    ...
    public static final Block MEMORY_CONSOLE = register("memory_console",
        new MemoryConsoleBlock(BlockBehaviour.Properties.of().strength(2.5f, 5.0f).sound(SoundType.METAL).lightLevel(s -> 6)));
    ...
    public static final Block TRIAL_TRIGGER = register("trial_trigger",
        new TrialTriggerBlock(BlockBehaviour.Properties.of().strength(3.5f, 7.0f)
            .lightLevel(s -> s.getValue(TrialTriggerBlock.TRIGGERED) ? 7 : 0)));
    public static final Block REWARD_VAULT = register("reward_vault",
        new RewardVaultBlock(BlockBehaviour.Properties.of().strength(4.0f, 8.0f).sound(SoundType.METAL)
