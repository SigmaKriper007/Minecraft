...
public class WarhammerItem extends SwordItem {
    ...
    @Override public boolean hurtEnemy(ItemStack stack, LivingEntity target, LivingEntity attacker){
        ...
        attacker.level().playSound(null,target.blockPosition(),ModSounds.HAMMER_HIT,SoundSource.PLAYERS,1.2f,.8f); return true;
    }
    @Override public InteractionResultHolder<ItemStack> use(Level level,Player player,InteractionHand hand){
        ...
        if(!player.getCooldowns().isOnCooldown(this)){
            ...
            level.playSound(null,player.blockPosition(),ModSounds.HAMMER_ULTIMATE,SoundSource.PLAYERS,2.0f,.55f);
