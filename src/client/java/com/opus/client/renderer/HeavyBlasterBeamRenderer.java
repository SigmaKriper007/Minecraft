...
import com.opus.client.model.HeavyBlasterBeamModel;
...
public class HeavyBlasterBeamRenderer extends GeoEntityRenderer<HeavyLaserBeamEntity> {

    private static final Vec3 BEAM_AXIS = new Vec3(0.0D, 0.0D, -1.0D);

    public HeavyBlasterBeamRenderer(EntityRendererProvider.Context context) {
        super(context, new HeavyBlasterBeamModel());
    }

    @Override
    public void preRender(PoseStack poseStack, HeavyLaserBeamEntity entity, BakedGeoModel model,
