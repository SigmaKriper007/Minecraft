...
/** Частица «ember ash» — фиолетовый пепел, медленно падает и покачивается. */
public class EmberAshParticle extends TextureSheetParticle {

    private final RandomSource random;

    protected EmberAshParticle(ClientLevel level, double x, double y, double z,
    ...
    public void tick() {
        ...
        this.setColor(0.36f, 0.29f, 0.32f);
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            return new EmberAshParticle(level, x, y, z, vx, vy, vz, sprites);
        }
    }
}
